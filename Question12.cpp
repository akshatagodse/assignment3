...
//Here I used map data structure because Data stored in a MAP structure can be retrieved much faster than list structures as the key is indexed.
// And data stored in MAP data structure is oredered data and accessability is also easy.
